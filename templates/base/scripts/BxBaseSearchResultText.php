...
class BxBaseSearchResultText extends BxBaseSearchResult
{
    ...
    function displaySearchUnit($aData)
    {
        ...
        $sCategoryLink = $this->getCurrentUrl('category', $aData['categoryId'], $aData['categoryUri'],
            array('ownerId' => $aData['ownerId'], 'ownerName' => $aData['ownerName']));
        ...
        // body
        $aUnit['body'] = isset($aData['bodyText']) ? process_html_output(strmaxtextlen(strip_tags($aData['bodyText']),
            200)) : '';
