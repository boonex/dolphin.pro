...
class BxBaseMenuQlinks2 extends BxBaseMenu
{
    ...
    function getCode()
    {
        ...
        return $GLOBALS['oSysTemplate']->parseHtmlByName('quick_links_list.html',
            array('content' => $this->genQuickLinks()));
    }
    ...
    function genQuickLinks()
    {
        ...
        foreach ($this->aTopMenu as $iItemID => $aItem) {
            ...
            $aQlinksUnits[_t($aItem['Caption'])] = $this->genQuickLink(_t($aItem['Caption']), $aItem['Link'],
                $aItem['Onclick'], $iItemID, $sPicture);
        }
    ...
    function genQuickLink($sText, $sLink, $sOnclick, $iItemID, $sPictureVal)
    {
        ...
        return $GLOBALS['oSysTemplate']->parseHtmlByName('quick_link.html', array(
            'bx_if:icon'     => array(
                ...
                'content'   => array(
                    'picture' => getTemplateIcon($sPictureVal),
                    'caption' => $sText,
