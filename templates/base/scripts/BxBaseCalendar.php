...
class BxBaseCalendar extends BxDolCalendar
{
    ...
    function display($isMiniMode = false)
    {
        ...
        $sTopControls = $GLOBALS['oSysTemplate']->parseHtmlByName('calendar' . ($isMiniMode ? '_mini' : '') . '_top_controls.html',
            $aVars);
        ...
        $sHtml = $GLOBALS['oSysTemplate']->parseHtmlByName($isMiniMode ? 'calendar_mini.html' : 'calendar.html',
            $aVars);
