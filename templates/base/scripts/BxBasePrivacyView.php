...
class BxBasePrivacyView extends BxDolPrivacyView
{
    ...
    function getBlockCode_AddMembers()
    {
        ...
        return PopupBox('ps-add-members', _t('_ps_bcpt_add_members'),
            $this->parseHtmlByName('ps_group_members.html', array(
                'wnd_action'        => 'add',
    ...
    function getBlockCode_DeleteMembers()
    {
        ...
        return PopupBox('ps-del-members', _t('_ps_bcpt_delete_members'),
            $this->parseHtmlByName('ps_group_members.html', array(
                'wnd_action'        => 'del',
                'bx_if:search_form' => array(
                    'condition' => false,
    ...
    {
        $sContent = "";
        $aValues  = array_merge(array('0' => _t('_ps_cpt_none')),
            $this->_getSelectItems(array('type' => 'extendable', 'owner_id' => $this->_iOwnerId)));
