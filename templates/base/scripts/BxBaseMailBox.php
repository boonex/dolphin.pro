...
class BxBaseMailBox extends BxDolMailBox
{
    ...
    function getBlockCode_ComposeMessage()
    {
        ...
        // check bloked;
        if (!isAdmin($this->aMailBoxSettings['member_id']) && isBlocked($this->aMailBoxSettings['recipient_id'],
        ...
        $aLanguageKeys = array(
            'cancel'        => _t('_Cancel'),
            'send'          => _t('_Send'),
            'send_copy'     => _t('_Send copy to personal email',
                isset($aMemberInfo['NickName']) ? $aMemberInfo['NickName'] : null),
            'send_copy_my'  => _t('_Send copy to my personal email'),
            'notify'        => _t('_Notify by e-mail',
                isset($aMemberInfo['NickName']) ? $aMemberInfo['NickName'] : null),
                ...
                case 'inbox' :
                        ...
                        'inputs' => array(
                            'actions' => array(
                                ...
                                array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.deleteMessages(' . $aRow['ID'] . ')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.spamMessages(\'\', ' . $aRow['Sender'] . ')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.markMessages(\'read\', ' . $aRow['ID'] . ')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.markMessages(\'unread\', ' . $aRow['ID'] . ')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                )
                            )
                    ...
                    if ($aRow['Sender'] != $this->aMailBoxSettings['member_id']) {
                        $aForm['inputs']['actions'][0] = array(
                            ...
                            'attrs' => array(
                                'onclick' => 'oMailBoxViewMessage.replyMessage(' . $this->aMailBoxSettings['messageID'] . ', ' . $aRow['Sender'] . ');',
                                'class'   => 'bx-btn-small'
                            ),
                        );
                    }
                        ...
                        'inputs' => array(
                            'actions' => array(
                                ...
                                1         => array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if (typeof oMailBoxViewMessage != \'undefined\') oMailBoxViewMessage.restoreMessages(' . $aRow['ID'] . ');',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                            )
    ...
    function getBlockCode_Contacts()
    {
        ...
        if ($this->aMailBoxSettings['contacts_mode'] && array_key_exists($this->aMailBoxSettings['contacts_mode'],
                $this->aRegisteredContactTypes)
        ) {
    ...
    function genArchiveMessages()
    {
        ...
        if (method_exists($this, $sFunctionName)) {
            ...
            if (is_array($aMessagesList) and !empty($aMessagesList)) {
                ...
                $sOutputHtml .= $oSysTemplate->parseHtmlByName($this->aUsedTemplates['archives_section'],
                    $aTemplateKeys);
            }
        }
        ...
        if ($iAllContactPages > 1) {
            ...
            $aTemplateKeys = array(
                'prev_link' => ($this->aMailBoxSettings['contacts_page'] > 1) ? _genPaginationItem('prev',
                    $this) : null,
                'next_link' => ($this->aMailBoxSettings['contacts_page'] < $iAllContactPages) ? _genPaginationItem('next',
                    $this) : null,
            );

            $sPaginationHtml .= $oSysTemplate->parseHtmlByName($this->aUsedTemplates['archives_pagina_section'],
                $aTemplateKeys);
        }
    ...
    function genMessagesRows()
    {
        ...
        if (is_array($this->aRegisteredMessageTypes) and !empty($this->aRegisteredMessageTypes)) {
            foreach ($this->aRegisteredMessageTypes AS $iKey => $sRegisteredType) {
                $sChecked = null;
                if (!empty($this->aReceivedMessagesTypes) and in_array($sRegisteredType,
                        $this->aReceivedMessagesTypes)
                ) {
                        ...
                        'inputs' => array(
                            'actions' => array(
                                ...
                                array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.deleteMessages(\'messages_container\', \'genMessagesRows\')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if (typeof oMailBoxMessages != \'undefined\') oMailBoxMessages.spamMessages(\'messages_container\')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                array(
                                    ...
                                    'value' => $aLanguageKeys['mark_read'],
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.markMessages(\'read\', \'genMessagesRows\')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                array(
                                    ...
                                    'value' => $aLanguageKeys['mark_unread'],
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.markMessages(\'unread\', \'genMessagesRows\')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                )
                            )
                        ...
                        'inputs' => array(
                            'actions' => array(
                                ...
                                0         => array(
                                    ...
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.restoreMessages(\'messages_container\', \'genMessagesRows\')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                                1         => array(
                                    ...
                                    'value' => $aLanguageKeys['delete'],
                                    'attrs' => array(
                                        'onclick' => 'if ( typeof oMailBoxMessages != \'undefined\' ) oMailBoxMessages.hideDeletedMessages(\'messages_container\', \'genMessagesRows\')',
                                        'class'   => 'bx-btn-small'
                                    ),
                                ),
                            ),
