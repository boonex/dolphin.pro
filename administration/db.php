...
$aTopItems = array(
    'main_menu1' => array('href'    => 'javascript:void(0)',
                          ...
                          'title'   => _t('_adm_dbtools_Tables_backup_tools'),
                          'active'  => 1
    ),
    'main_menu2' => array('href'    => 'javascript:void(0)',
                          'onclick' => 'javascript:switchAdmPage(this)',
                          'title'   => _t('_adm_dbtools_Database_backup_tools'),
                          'active'  => 0
    )
);
...
function getTablesBackupTools($status_text)
{
    ...
    return $GLOBALS['oAdmTemplate']->parseHtmlByName('design_box_content.html',
        array('content' => $oForm->getCode() . $sStatusText));
...
function getDatabaseRestoreBlock($status_text)
{
    ...
    return $GLOBALS['oAdmTemplate']->parseHtmlByName('design_box_content.html',
        array('content' => $oForm->getCode() . '<br />' . $oForm2->getCode() . $sStatusText));
}
