...
function getAge($sDob)
{
    ...
    if ($iDobMonth > date('m')) {
        ...
        if ($iDobMonth == date('m') && $iDobDay > date('d')) {
            $iAge--;
        }
    }
...
function searchUser($sValue, $sField = "ID")
{
    if ($sField == "ID") {
        $sField = "ID";
    }//you migth change this value on your user's ID column name
    else {
        $sField = "NickName";
    }//you migth change this value on your user's nick column name
