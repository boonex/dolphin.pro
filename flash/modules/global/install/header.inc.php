 ...
 */
if (!defined("DB_HOST")) {
    define("DB_HOST", "#globals_db_server#");
}
if (!defined("DB_PORT")) {
    define("DB_PORT", "#globals_db_port#");
}
if (!defined("DB_SOCKET")) {
    define("DB_SOCKET", "#globals_db_socket#");
}
if (!defined("DB_NAME")) {
    define("DB_NAME", "#globals_db_name#");
}
if (!defined("DB_USER")) {
    define("DB_USER", "#globals_db_login#");
}
if (!defined("DB_PASSWORD")) {
    define("DB_PASSWORD", "#globals_db_password#");
}
if (!defined("DB_PREFIX")) {
    define("DB_PREFIX", "#globals_db_prefix#");
}
...
if (!defined("MODULE_DB_PREFIX")) {
    define("MODULE_DB_PREFIX", DB_PREFIX . $sDBModule);
}
