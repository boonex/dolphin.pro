...
function postVideo($sUploadedFile, $aFileInfo)
{
    ...
    $aResult = initVideo($sId, $aFileInfo['category'], addslashes($aFileInfo['title']), addslashes($aFileInfo['tags']),
...
function video_getList($sId)
{
    ...
    for ($i = 0; $i < count($aData); $i++) {
        ...
        $sResult .= parseXml($aXmlTemplates['file'], $sThumbFile, $aData[$i]['size'], $aData[$i]['ownerName'],
