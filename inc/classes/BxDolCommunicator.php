...
class BxDolCommunicator extends BxDolPageView
{
    ...
    function __construct($aCommunicatorSettings)
    {
        ...
        $aCommunicatorSettings['communicator_mode'] = process_db_input($aCommunicatorSettings['communicator_mode'],
            BX_TAGS_STRIP);
        $aCommunicatorSettings['person_switcher']   = process_db_input($aCommunicatorSettings['person_switcher'],
            BX_TAGS_STRIP);
        $aCommunicatorSettings['sorting']           = process_db_input($aCommunicatorSettings['sorting'],
            BX_TAGS_STRIP);
    ...
    {
        return 'oCommunicatorPage' . str_replace(' ', '',
            ucwords(str_replace('_', ' ', $this->aCommunicatorSettings['communicator_mode'])));
    }
}
