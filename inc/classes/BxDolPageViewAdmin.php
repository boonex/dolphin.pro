...
class BxDolPageViewAdmin
{
    ...
    function saveItem($aData)
    {
        ...
        $oZ = new BxDolAlerts('page_builder', 'block_form_save', $iID, 0,
            array('data' => $aData, 'caption_key' => &$sCaption));
        $oZ->alert();
    ...
    function getCssCode()
    {
        return $GLOBALS['oAdmTemplate']->addCss(array(
            'general.css',
            'forms_adv.css',
    ...
    function showBuildZone()
    {
        ...
        return /*$sInitEditor. */
            $GLOBALS['oAdmTemplate']->parseHtmlByName('pbuilder_content.html', array(
    ...
    function showPropForm($iBlockID)
    {
        ...
        switch ($aItem['Func']) {
            ...
            case 'Echo':
                ...
                break;
            case 'Text':
                $sBlockType = $sTextBlockC;
                break;
            case 'Code':
                $sBlockType = $sPhpBlockC;
                break;
            case 'XML':
    ...
    function showNewPageForm()
    {
        ...
        return $GLOBALS['oFunctions']->popupBox('adm-pbuilder-add-page', _t('_adm_pbuilder_Create_new_page'),
            $sContent);
    }
}
