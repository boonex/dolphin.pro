...
class BxDolModuleTemplate extends BxDolTemplate
{
    ...
    function addAdminCss($mixedFiles, $bDynamic = false)
    {
        ...
        $sLocationKey = $oAdmTemplate->addDynamicLocation($this->_oConfig->getHomePath(),
    ...
    function addAdminJs($mixedFiles, $bDynamic = false)
    {
        ...
        $sLocationKey = $oAdmTemplate->addDynamicLocationJs($this->_oConfig->getHomePath() . 'js/',
            $this->_oConfig->getHomeUrl() . 'js/');
