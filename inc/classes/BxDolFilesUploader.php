    ...
    ****************************************************************************/
    function _GenMainAddCommonForm($aExtras = array(), $aUploaders = array())
    {
        ...
        if (array_key_exists($sMode, $aUplMethods)) {
            if (is_array($aUplMethods[$sMode])) {
                $aUplMethods[$sMode]['params'] = array_merge(is_array($aUplMethods[$sMode]['params']) ? $aUplMethods[$sMode]['params'] : array(), array('extras' => $this->_aExtras));
    ...
    function getUploadHtml5File($aExtras)
    {
        ...
        $aVars = array(
            ...
            'preview_size' => 240,
            'action_url' => bx_append_url_params($this->sWorkingFile, array('action' => $aUploaders['html5']['action'])),
            ...
            'max_file_size_exceeded' => bx_js_string(_t('_sys_txt_upload_size_error', _t_format_size($this->iMaxFilesize)), BX_ESCAPE_STR_APOS),
        );
