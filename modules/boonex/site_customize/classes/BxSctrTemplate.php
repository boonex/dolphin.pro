...
class BxSctrTemplate extends BxDolModuleTemplate
{
    ...
    function getAdminPage($sType = '', $iUnitId = '')
    {
        ...
        switch ($sSelType) {
            case 'themes':
                $sContent .= $this->adminBlock($this->getAdminPageThemes($sSelType), _t('_bx_sctr_page_themes'),
                    $aMenu);
                break;

            case 'import':
                $sContent .= $this->adminBlock($this->getAdminPageImport($sSelType), _t('_bx_sctr_page_import'),
                    $aMenu);
                break;
        }
