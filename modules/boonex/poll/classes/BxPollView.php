...
class BxPollView extends BxDolPageView
{
    ...
    function getBlockCode_ActionsBlock()
    {
        ...
        if (BxDolRequest::serviceExists('wall', 'get_repost_js_click')) {
            ...
            $aUnitInfo['repostScript'] = BxDolService::call('wall', 'get_repost_js_click',
                array($this->iMemberId, $sMainPrefix, 'add', $this->aPollInfo['id_poll']));
        }
    ...
    function getBlockCode_CommentsBlock()
    {
        ...
        if ($this->oModule->oPrivacy->check('comment', $this->aPollInfo['id_poll'],
            $oPoll->aPollSettings['member_id'])
        ) {
