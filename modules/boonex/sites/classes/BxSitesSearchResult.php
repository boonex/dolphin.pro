...
class BxSitesSearchResult extends BxTemplSearchResult
{
    ...
    function displayResultBlock($bPagination = false, $isAjax = false)
    {
        ...
        if ($s) {
            $GLOBALS['oSysTemplate']->addDynamicLocation($this->_oMain->_oConfig->getHomePath(),
                $this->_oMain->_oConfig->getHomeUrl());
    ...
    function displaySearchUnit($aData)
    {
        switch ($this->sUnitName) {
            case 'unit':
                return $this->_oMain->_oTemplate->unit($aData, $this->sUnitTemplate, $this->oVotingView,
                    $this->sThumbSize);
                break;
