    ...
    function getBottomMenu($sAllLinkType = 'browseAll', $iId = 0, $sUri = '', $aExclude = array(), $bPgnSim = true)
    {
        ...
        if ($this->aCurrent['paginate']['totalPages'] > 1) {
            ...
            if ($this->aCurrent['paginate']['page'] > 1) {
                ...
                $aDBBottomMenu[_t('_Back')] = array('href'       => bx_html_attribute($_SERVER['PHP_SELF']) . "?ads_mode={$this->aCurrent['sorting']}&amp;page=$iPrevPage{$sUserAddon}{$sFileAddon}",
                                                    'dynamic'    => true,
                                                    'class'      => 'backMembers',
                                                    'icon_class' => 'left'
                );
            ...
            if ($this->aCurrent['paginate']['page'] < $this->aCurrent['paginate']['totalPages']) {
                ...
                $aDBBottomMenu[_t('_Next')] = array('href'    => bx_html_attribute($_SERVER['PHP_SELF']) . "?ads_mode={$this->aCurrent['sorting']}&amp;page=$iNextPage{$sUserAddon}{$sFileAddon}",
                                                    'dynamic' => true,
                                                    'class'   => 'moreMembers'
                );
            } else {
            ...
            $aDBBottomMenu[_t('_View All') . ' (' . $this->aCurrent['paginate']['totalNum'] . ')'] = array('href'  => "$sAllUrl",
                                                                                                           'class' => $sViewAllClass
            );
        }
