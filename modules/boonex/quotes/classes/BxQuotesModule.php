...
class BxQuotesModule extends BxDolModule
{
    ...
    function getQuotesList()
    {
        ...
        $sAdmPanel     = $oSearchResult->showAdminActionsPanel('quotes_box', array('action_delete' => '_Delete'),
            'quotes_list');
...
EOF;
        ...
        $sActions = /*BxDolPageView::getBlockCaptionMenu(mktime(),*/
            array(
                'add_unit' => array('href'    => $sAction,
                                    'title'   => _t('_bx_quotes_add_new'),
                                    'onclick' => '',
                                    'active'  => 0
                ),
            )/*)*/
