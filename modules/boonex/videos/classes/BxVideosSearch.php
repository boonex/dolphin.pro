...
class BxVideosSearch extends BxTemplSearchResultSharedMedia
{
    function __construct($sParamName = '', $sParamValue = '', $sParamValue1 = '', $sParamValue2 = '')
    {
        ...
        switch ($sParamName) {
            case 'calendar':
                ...
                $this->aCurrent['title']                       = _t('_bx_videos_caption_browse_by_day') . sprintf("%04u-%02u-%02u",
    ...
    {
        return $this->oTemplate->getFileConcept($aVideo['ID'],
            array('ext' => $aVideo['video'], 'source' => $aVideo['source']));
    }
    ...
    function serviceProfileVideoBlock($iProfileId)
    {
        ...
        foreach ($aFiles as $aFile) {
            $aVars['bx_repeat:videos'][] = array(
                ...
                'id'    => $aFile['id'],
                'video' => $this->oTemplate->getFileConcept($aFile['id'],
                    ($aFile['source'] == 'youtube' ? array('ext' => $aFile['video']) : array())),
            );
