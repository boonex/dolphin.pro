...
class BxVideosConfig extends BxDolFilesConfig
{
    ...
    function __construct(&$aModule)
    {
        ...
        $this->aFilesConfig = array(
            ...
            'browse'   => array(
                'postfix' => THUMB_FILE_NAME . IMAGE_EXTENSION,
                'image'   => true,
                'w'       => 240,
                'h'       => 240,
                'square'  => true
            ...
            'browse2x' => array(
                'postfix' => THUMB_FILE_NAME . '_2x' . IMAGE_EXTENSION,
                'image'   => true,
                'w'       => 480,
                'h'       => 480,
                'square'  => true
        ...
        if (!defined("YOUTUBE_VIDEO_PLAYER")) {
            define("YOUTUBE_VIDEO_PLAYER",
                '<iframe width="100%" height="360" src="' . $sProto . '://www.youtube-nocookie.com/embed/#video#?rel=0&amp;showinfo=0#autoplay#" frameborder="0" allowfullscreen></iframe>');
        }

        if (!defined("YOUTUBE_VIDEO_EMBED")) {
            define("YOUTUBE_VIDEO_EMBED",
                '<iframe width="480" height="360" src="' . $sProto . '://www.youtube-nocookie.com/embed/#video#?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>');
        }
