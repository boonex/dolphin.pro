 ...
 */
class BxVideosSiteMapsAlbums extends BxDolSiteMaps
{
    protected $_oModule;
    ...
    protected function __construct($aSystem)
    {
        ...
        $this->_aQueryParts = array (
            ...
            'join' => "", // join SQL part
            'where' => "AND `Type` = 'bx_videos' AND `Status` = 'active' AND `ObjCount` > 0 AND `AllowAlbumView` = '" . BX_DOL_PG_ALL . "'", // SQL condition, without WHERE
