...
('[db_prefix]_number_all', '12', @iKatID, 'How many videos show on browse videos page', 'digit', '', '', 20, ''),
('[db_prefix]_number_index', '9', @iKatID, 'How many videos show on main index page', 'digit', '', '', 21, ''),
('[db_prefix]_number_top', '3', @iKatID, 'How many videos show in featured, top, and similar sections', 'digit', '', '', 22, ''),
('[db_prefix]_number_related', '3', @iKatID, 'Number of related videos by user', 'digit', '', '', 24, ''),
('[db_prefix]_number_previous_rated', '3', @iKatID, 'Number of previous rated videos', 'digit', '', '', 25, ''),
('[db_prefix]_number_albums_browse', '9', @iKatID, 'How many albums show on browse albums page', 'digit', '', '', 27, ''),
('[db_prefix]_number_albums_home', '3', @iKatID, 'How many albums show on videos home page', 'digit', '', '', 28, ''),
