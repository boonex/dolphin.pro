...
$_page_cont[$iIndex]['page_main_code'] .= DesignBoxAdmin(_t('_payment_bcpt_settings'),
    $GLOBALS['oAdmTemplate']->parseHtmlByName('design_box_content.html',
        array('content' => $oPayments->getSettingsForm($mixedResultSettings))));
$_page_cont[$iIndex]['page_main_code'] .= DesignBoxAdmin(_t('_payment_bcpt_details'),
