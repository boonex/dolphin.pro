...
class BxFilesPageAlbumsMy extends BxDolPageView
{
    ...
    function getBlockCode_my($iBoxId)
    {
        ...
        $sCode                                                           = $this->oSearch->getAlbumList($iPage,
            $iPerPage, array('owner' => $this->iOwnerId, 'show_empty' => true, 'hide_default' => true));
    ...
    function getBlockCode_add()
    {
        ...
        $aPrivFieldView = $this->oAlbumPrivacy->getGroupChooser($this->iOwnerId, $this->oConfig->getUri(), 'album_view',
            array(), _t('_' . $this->oConfig->getMainPrefix() . '_album_view'));
    ...
    function getBlockCode_manageObjects($iBoxId)
    {
        if (in_array('manageObjects', $this->aCurrentBlocks['blocks'])) {
            return array(
                $this->getAdminObjectPart(array('activeStatus' => 'approved'), $iBoxId, true),
    ...
    function getBlockCode_manageObjectsDisapproved($iBoxId)
    {
        if (in_array('manageObjectsDisapproved', $this->aCurrentBlocks['blocks'])) {
            return array(
                $this->getAdminObjectPart(array('activeStatus' => 'disapproved'), $iBoxId),
    ...
    function getBlockCode_manageObjectsPending($iBoxId)
    {
        if (in_array('manageObjectsPending', $this->aCurrentBlocks['blocks'])) {
            return array(
                $this->getAdminObjectPart(array('activeStatus' => 'pending'), $iBoxId),
                $this->getTopMenu('manage_objects_pending'),
                array(),
                ''
            );
        }
    ...
    function getBlockCode_edit()
    {
        ...
        $aPrivFieldView          = $this->oAlbumPrivacy->getGroupChooser($this->iOwnerId, $this->oConfig->getUri(),
            'album_view', array(), _t('_' . $this->oConfig->getMainPrefix() . '_album_view'));
