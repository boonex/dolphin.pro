...
class BxWallDb extends BxDolModuleDb
{
        ...
        switch ($aParams['browse']) {
            ...
            case 'owner':
                if ($sWhereModuleFilter == '') {
                    ...
                    $sWhereModuleFilter = "AND `th`.`timeline`='1' AND `th`.`id` NOT IN ('" . implode("','",
                            $aHidden) . "') ";
                }
                ...
                $sWhereClause .= isset($aParams['filter']) ? $this->_getFilterAddon($aParams['owner_id'],
                    $aParams['filter']) : '';
            ...
            case BX_WALL_VIEW_OUTLINE:
                if ($sWhereModuleFilter == '') {
                    ...
                    $sWhereModuleFilter = "AND `th`.`outline`='1' AND `th`.`id` NOT IN ('" . implode("','",
                            $aHidden) . "') ";
                }
    ...
    function getReposted($sType, $sAction, $iObjectId)
    {
        ...
        if ($bSystem) {
            $aParams = array('browse'    => 'descriptor',
                             'type'      => $sType,
                             'action'    => $sAction,
                             'object_id' => $iObjectId
            );
