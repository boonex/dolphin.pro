...
class BxStoreFormAdd extends BxDolFormMedia
{
    ...
    function __construct($oMain, $iProfileId, $isRemovePhotoFieldAllowed = true, $iEntryId = 0, $iThumb = 0)
    {
        ...
        $aFilesChoiceOrig = $this->_getFilesInEntry('files', 'get_file_array', 'ready_files', 'files', (int)$iProfileId,
            $iEntryId);
        $aFilesChoice     = array();
        ...
        $aInputPrivacyPurchase = $GLOBALS['oBxStoreModule']->_oPrivacyProduct->getGroupChooser($iProfileId, 'store',
            'purchase');
         ...
         */
        $sInputPrivacyPurchase = str_replace('name="allow_purchase_to"', 'name="allow_purchase_to[]"',
            $this->genInputSelect($aInputPrivacyPurchase));
        ...
        $aVarsFilesUpload = array(
            ...
            'bx_if:price'       => array(
                'condition' => true,
                'content'   => array('price'            => 'files_prices',
                                     'file_price_title' => _t('_bx_store_form_caption_file_price')
                )
            ),
            'bx_if:privacy'     => array(
                'condition' => true,
                'content'   => array('select'                => $sInputPrivacyPurchase,
                                     'file_permission_title' => _t('_bx_store_form_caption_file_allow_purcase_to')
                )
            ),
        );
        ...
        $aInputPrivacyPostInForum           = $GLOBALS['oBxStoreModule']->_oPrivacyProduct->getGroupChooser($iProfileId,
            'store', 'post_in_forum');
        ...
        $aInputPrivacyViewForum           = $GLOBALS['oBxStoreModule']->_oPrivacyProduct->getGroupChooser($iProfileId,
            'store', 'view_forum');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'files_choice' => array(
                    'type'     => 'custom',
                    'content'  => $aFilesChoice ? $GLOBALS['oBxStoreModule']->_oTemplate->parseHtmlByName('form_field_product_files_choice',
                        $aVarsFilesChoice) : '',
                    'name'     => 'files_choice[]',
                ...
                'files_upload' => array(
                    'type'     => 'custom',
                    'content'  => $GLOBALS['oBxStoreModule']->_oTemplate->parseHtmlByName('form_field_files_upload',
                        $aVarsFilesUpload),
                    'name'     => 'files_upload[]',
                ...
                'allow_view_product_to' => $GLOBALS['oBxStoreModule']->_oPrivacyProduct->getGroupChooser($iProfileId,
                    'store', 'view_product'),
