        ...
        switch ($sMode) {
            ...
            case 'pending':
                if (false !== bx_get('bx_store_filter')) {
                    $this->aCurrent['restriction']['keyword'] = array('value'    => process_db_input(bx_get('bx_store_filter'),
                        BX_TAGS_STRIP),
                                                                      'field'    => '',
                                                                      'operator' => 'against'
                    );
            ...
            case 'search':
                ...
                $this->aCurrent['title'] = _t('_bx_store_page_title_search_results') . ' ' . (is_array($sValue2) ? implode(', ',
            ...
            case 'user':
                ...
                $this->aCurrent['title'] = _t('_bx_store_page_title_browse_by_author',
            ...
            case 'category':
                ...
                $this->aCurrent['title']                                 = _t('_bx_store_page_title_browse_by_category',
                    $sValue);
                break;
            ...
            case 'free':
                $this->aCurrent['restriction']['price'] = array('value'    => 'Free',
                                                                'field'    => 'price_range',
                                                                'operator' => '='
                );
