...
class BxStorePageView extends BxDolTwigPageView
{
    ...
    function getBlockCode_Actions()
    {
        ...
        if ($this->_oMain->_iProfileId || $this->_oMain->isAdmin()) {
            ...
            $aSubscribeButton = $oSubscription->getButton($this->_oMain->_iProfileId, 'bx_store', '',
            ...
            $aInfo = array(
                ...
                'TitleActivate'   => method_exists($this->_oMain,
                    'isAllowedActivate') && $this->_oMain->isAllowedActivate($this->aDataEntry) ? _t('_bx_store_admin_activate') : '',
            );
            ...
            if (BxDolRequest::serviceExists('wall', 'get_repost_js_click')) {
                ...
                $aInfo['repostScript'] = BxDolService::call('wall', 'get_repost_js_click',
                    array($this->_oMain->_iProfileId, 'bx_store', 'add', (int)$this->aDataEntry['id']));
            }
