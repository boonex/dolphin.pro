...
('[db_prefix]_number_all', '12', @iKatID, 'How many photos show on browse photos page', 'digit', '', '', 20, ''),
('[db_prefix]_number_index', '9', @iKatID, 'How many photos show on main index page', 'digit', '', '', 21, ''),
('[db_prefix]_number_top', '6', @iKatID, 'How many photos show in featured, top, and similar sections', 'digit', '', '', 22, ''),
('[db_prefix]_number_related', '3', @iKatID, 'Number of related photos by user', 'digit', '', '', 24, ''),
('[db_prefix]_number_previous_rated', '3', @iKatID, 'Number of previous rated photos', 'digit', '', '', 25, ''),
('[db_prefix]_number_albums_browse', '9', @iKatID, 'How many albums show on browse albums page', 'digit', '', '', 27, ''),
('[db_prefix]_number_albums_home', '3', @iKatID, 'How many albums show on photos home page', 'digit', '', '', 28, ''),
...
('[db_prefix]_view', '1140px', '', '_[db_prefix]_album_photos_rest', 3, 5, 'ViewAlbum', '', 1, 28.1, 'non,memb', 0),
...
('[db_prefix]_albums_my', '1140px', '', '_[db_prefix]_albums_my', 2, 34, 'my', '', 1, 100, 'memb', 0);

INSERT INTO `sys_page_compose` (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`) VALUES
('[db_prefix]_albums_owner', '1140px', '', '_[db_prefix]_photo_album_block', 2, 1, 'ProfilePhotos', '', 1, 71.9, 'non,memb', 0),
('[db_prefix]_albums_owner', '1140px', '', '_[db_prefix]_albums_owner', 2, 2, 'Browse', '', 1, 71.9, 'non,memb', 0),
