 ...
 */
class BxPhotosSiteMapsAlbums extends BxDolSiteMaps
{
    protected $_oModule;
    ...
    protected function __construct($aSystem)
    {
        ...
        $this->_aQueryParts = array(
            ...
            'join'            => "",
            // join SQL part
            'where'           => "AND `Type` = 'bx_photos' AND `Status` = 'active' AND `ObjCount` > 0 AND `AllowAlbumView` = '" . BX_DOL_PG_ALL . "'",
