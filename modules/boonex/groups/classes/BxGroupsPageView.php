...
class BxGroupsPageView extends BxDolTwigPageView
{
    ...
    {
        return array(
            $this->_blockInfo($this->aDataEntry, $this->_oTemplate->blockFields($this->aDataEntry),
                $this->_oMain->_formatLocation($this->aDataEntry, false, true))
        );
    }
    ...
    function getBlockCode_Actions()
    {
        ...
        if ($this->_oMain->_iProfileId || $this->_oMain->isAdmin()) {
            ...
            $aSubscribeButton = $oSubscription->getButton($this->_oMain->_iProfileId, 'bx_groups', '',
            ...
            $aInfo = array(
                ...
                'TitleActivate'     => method_exists($this->_oMain,
                    'isAllowedActivate') && $this->_oMain->isAllowedActivate($this->aDataEntry) ? _t('_bx_groups_admin_activate') : '',
            );
            ...
            if (BxDolRequest::serviceExists('wall', 'get_repost_js_click')) {
                ...
                $aInfo['repostScript'] = BxDolService::call('wall', 'get_repost_js_click',
                    array($this->_oMain->_iProfileId, 'bx_groups', 'add', (int)$this->aDataEntry['id']));
            }
