        ...
        switch ($sMode) {
            ...
            case 'pending':
                if (false !== bx_get('bx_groups_filter')) {
                    $this->aCurrent['restriction']['keyword'] = array('value'    => process_db_input(bx_get('bx_groups_filter'),
                        BX_TAGS_STRIP),
                                                                      'field'    => '',
                                                                      'operator' => 'against'
                    );
            ...
            case 'search':
                ...
                $this->aCurrent['title'] = _t('_bx_groups_page_title_search_results') . ' ' . (is_array($sValue2) ? implode(', ',
            ...
            case 'user':
                ...
                $this->aCurrent['title'] = _t('_bx_groups_page_title_browse_by_author',
            ...
            case 'joined':
                ...
                $iProfileId              = getID($sValue);
                $this->aCurrent['title'] = _t('_bx_groups_page_title_browse_by_author_joined_groups',
                    $iProfileId ? getNickName($iProfileId) : $sValue);
            ...
            case 'category':
                ...
                $this->aCurrent['title']                                 = _t('_bx_groups_page_title_browse_by_category',
                    $sValue);
                break;
