...
class BxOAuthModule extends BxDolModule
{
    ...
    function actionApi($sAction)
    {
        ...
        if (!$sAction || !method_exists($this->_oAPI, $sAction) || 0 == strcasecmp('errorOutput',
                $sAction) || 0 == strcasecmp('output', $sAction)
        ) {
        ...
        if (false === strpos($sScope, $aToken['scope'])) {
            $this->_oAPI->errorOutput(403, 'insufficient_scope',
    ...
    function actionAdministration()
    {
        ...
        echo $this->_oTemplate->adminBlock($this->_oTemplate->parseHtmlByName('clients', $aVars),
            _t('_bx_oauth_clients'));
