...
class BxDolXMLRPCMediaVideo extends BxDolXMLRPCMedia
{
    ...
    {
        return BxDolXMLRPCMedia::_uploadFile('video', $sUser, $sPwd, $sAlbum, $binImageData, $iDataLength, $sTitle,
            $sTags, $sDesc, $sExt);
    }
    ...
    function getVideoInAlbum($sUser, $sPwd, $sNick, $iAlbumId)
    {
        ...
        return BxDolXMLRPCMedia::_getFilesInAlbum('videos', $iIdProfile, $iId, $iAlbumId, 'video', 'getToken',
            'flash/modules/video/get_mobile.php?id=');
    }
}
