...
class CategoriesCalendarPage extends BxDolPageView
{
    ...
    function getBlockCode_CategoriesDate($iBlockId)
    {
        if (isset($_GET['year']) && isset($_GET['month']) && isset($_GET['day'])) {
            ...
            return showCategories($aParam, $iBlockId, BX_CATEG_ACTION_CALENDAR, false, false,
                _t('_categ_caption_calendar'));
        } else {
            return MsgBox(_t('_Empty'));
        }
    }
...
class CategoriesSearchPage extends BxDolPageView
{
    ...
    function getBlockCode_Founded($iBlockId)
    {
        ...
        if (isset($aParam['filter'])) {
            return showCategories($aParam, $iBlockId, BX_CATEG_ACTION_SEARCH, false, false,
                _t('_categ_caption_founded_categ'));
        } else {
            return MsgBox(_t('_Empty'));
        }
    }
